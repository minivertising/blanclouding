<?php
	...
	switch ($_REQUEST['exec'])
	{
		...
		case "all_send_sms" :
			$query = "SELECT mb_phone, mb_s_url, mb_nansu FROM ".$_gl['member_info_table']." WHERE mb_winner='Y' AND mb_use='N' AND mb_s_url<>'' AND mb_phone='010-2617-9309'";
