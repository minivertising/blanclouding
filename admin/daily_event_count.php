...
<?php 
	...
	{		
		$pc_query		= "SELECT * FROM ".$_gl['tracking_info_table']." WHERE tracking_date LIKE  '%".$date_data['mb_date']."%' AND tracking_gubun='PC'";
		$pc_count		= mysqli_num_rows(mysqli_query($my_db, $pc_query));
		$mobile_query	= "SELECT * FROM ".$_gl['tracking_info_table']." WHERE tracking_date LIKE  '%".$date_data['mb_date']."%' AND tracking_gubun='MOBILE'";
